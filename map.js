	...
	firecenter[0] = [9,40.114593,-104.773525]; //default -- state of Colorado
    ...
    layers[1] = new google.maps.KmlLayer('http://extras.denverpost.com/media/maps/kml/2013/colorado-flooding-photo-map-20130919-1308.kml', {preserveViewport: true});
...
/* layer toggles */
		...
		/*
		google.maps.event.addListenerOnce(layers[1], "status_changed", function() {
		    layers[2].setMap(map);
		});

		google.maps.event.addListenerOnce(layers[2], "status_changed", function() {
			layers[3].setMap(map);
		});
   		*/
